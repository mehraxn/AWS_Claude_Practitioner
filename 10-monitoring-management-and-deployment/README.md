...
| [AWS Systems Manager](aws-systems-manager/01-overview.md) | Awareness | Architecture | Batch 6 complete |
...
## Batch 6 Decision Guide

- [CloudWatch vs CloudTrail vs AWS Config](../15-comparisons-and-decision-guides/operations/01-cloudwatch-vs-cloudtrail-vs-config.md)
