...
- [Scope ledger](PHASE-6-BATCH-1-SCOPE.csv)
- [Pre-implementation manifest](PHASE-6-BATCH-1-PRE-IMPLEMENTATION.csv)
- [Post-implementation manifest](PHASE-6-BATCH-1-POST-IMPLEMENTATION.csv)
- [Content decisions](PHASE-6-BATCH-1-CONTENT-DECISIONS.md)
- [Fact corrections](PHASE-6-BATCH-1-FACT-CORRECTIONS.md)
- [Coverage delta](PHASE-6-BATCH-1-COVERAGE-DELTA.md)
- [Backlog status](PHASE-6-BACKLOG-STATUS.csv)
- [Batch 1 changelog](PHASE-6-BATCH-1-CHANGELOG.md)
...
- [Scope ledger](PHASE-6-BATCH-5-SCOPE.csv)
- [Pre-implementation manifest](PHASE-6-BATCH-5-PRE-IMPLEMENTATION.csv)
- [Post-implementation manifest](PHASE-6-BATCH-5-POST-IMPLEMENTATION.csv)
- [Content decisions](PHASE-6-BATCH-5-CONTENT-DECISIONS.md)
