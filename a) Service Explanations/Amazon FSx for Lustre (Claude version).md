...
- Sub-millisecond latency — Extremely fast readwrite speeds
- High throughput — Can deliver hundreds of GBs of data
- Parallel access — Thousands of compute instances can readwrite at the same time
...
Step 4 Your EC2 instances (or HPC cluster) mount the file system
         ↓
Step 5 All compute nodes readwrite at high speed in parallel
         ↓
...
- While FSx for Lustre is LinuxPOSIX-based, remember FSx for Windows exists too
...
------
 ...
 Speed  Sub-millisecond latency, hundreds of GBs 
...
Study notes prepared for AWS Certified Cloud Practitioner (CLF-C02)
Topic Storage Services  Amazon FSx for Lustre